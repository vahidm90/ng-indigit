...
const NUMBER_UTIL = {
    sanitize: s => { var _a; return ((_a = BASIC_UTIL.stringify(s)) === null || _a === void 0 ? void 0 : _a.replace(/\D/g, '')) || ''; },
    faToEn: (subject) => {
        var _a;
        const value = (typeof subject === 'string') ? subject : BASIC_UTIL.stringify(subject);
        return ((_a = value === null || value === void 0 ? void 0 : value.replace(/[\u0660-\u0669]/g, c => `${c.charCodeAt(0) - 0x0660}`)) === null || _a === void 0 ? void 0 : _a.replace(/[\u06f0-\u06f9]/g, c => `${c.charCodeAt(0) - 0x06f0}`)) || '';
    }
};
...
const DIGIT_GROUP_UTIL = {
    apply: (subject, params, isSafeSubject) => {
        ...
        return params.groupSize
            ? ((value === null || value === void 0 ? void 0 : value.replace(RegExp(`(\\d)(?=(\\d{${params.groupSize}})+$)`, 'g'), `$1${params.delimiter}`)) || '')
            : value;
    }
};
...
const sanitize = (subject, point, digitGroup, isSafeSubject) => {
    ...
    return (digitGroup === null || digitGroup === void 0 ? void 0 : digitGroup.hasDigitGroups)
...
const digitGroupDefaults = {
    integerPart: Object.assign({}, DEFAULT_CONFIG.digitGroups),
    decimalPart: Object.assign({}, DEFAULT_CONFIG.digitGroups),
...
const digitGroupParamFromGenericOption = (option, preset) => {
    const params = Object.assign({}, preset);
...
const digitGroupParamFromPrettyFloatOption = (option, preset) => {
    ...
    ['integerPart', 'decimalPart']
        ...
        if (isDigitGroupOptionObject(partOption))
            params[part] = Object.assign(Object.assign({}, params[part]), sanitizeDigitGroupDelimiter(partOption));
        else if (partOption === false)
            params[part] = Object.assign(Object.assign({}, params[part]), { groupSize: 0 });
    });
    return params;
};
const PRETTY_FLOAT_PARAM_UTIL = {
    decimal: options => {
        ...
        const defaults = Object.assign(Object.assign({}, decimalDefaults), { isDecimalAllowed: false });
        if (isPrettyFloatDecimalOptionObject(options)) {
            ...
            return Object.assign(Object.assign(Object.assign({}, defaults), options), { isDecimalAllowed: (_a = options.isDecimalAllowed) !== null && _a !== void 0 ? _a : (options.maxDigitCount !== 0) });
        }
        return Object.assign(Object.assign({}, defaults), { isDecimalAllowed: makeBoolean(options) });
    },
    digitGroup: (...options) => {
        var _a;
        if (!makeBoolean(options))
            return digitGroupDefaults;
        let params = Object.assign({}, digitGroupDefaults);
        for (const option of options) {
            ...
            params.hasDigitGroups
                = (_a = option.hasDigitGroups) !== null && _a !== void 0 ? _a : ((params.integerPart.groupSize > 0) || (params.decimalPart.groupSize > 0));
        }
        return params;
    }
};
...
class PrettyFloat {
    ...
    get digitGroupDelimiters() {
        var _a;
        const delimiters = [];
        if (!((_a = this._digitGroupParams) === null || _a === void 0 ? void 0 : _a.hasDigitGroups))
            return delimiters;
    ...
    get intPart() {
        var _a;
        const value = Number((_a = this._value.number) === null || _a === void 0 ? void 0 : _a.toFixed());
    ...
    updateNumberValuePointIndex() {
        var _a;
        this._pointIndex.numberIndex = `${(_a = this.numberValue) !== null && _a !== void 0 ? _a : ''}`.indexOf('.');
    }
    ...
    initValues(subject, decimal, digitGroup) {
        ...
        this.value = ((_a = this._decimalParams) === null || _a === void 0 ? void 0 : _a.isDecimalAllowed)
...
class IndigitDirective {
    ...
    onInput() {
        ...
        this.updateAfterUserInput(this._value.updateValue(this._inputElement.value), ((_a = history[history.length - 1]) === null || _a === void 0 ? void 0 : _a.value) || null);
    }
    onBlur() {
        this.clearHistory();
        this._onTouched();
    ...
    get selectionStartFromHost() {
        var _a;
        return ((_a = this._inputElement) === null || _a === void 0 ? void 0 : _a.selectionStart) || 0;
    }
    get selectionEndFromHost() {
        var _a;
        return ((_a = this._inputElement) === null || _a === void 0 ? void 0 : _a.selectionEnd) || 0;
    }
    ...
    updateAfterUserInput(newValue, oldValue) {
        if (!(oldValue === null || oldValue === void 0 ? void 0 : oldValue.prettyValue) || !newValue.prettyValue)
            this._nextIndicatorPosition = 'endOfLine';
        const oldForcedDecimals = oldValue === null || oldValue === void 0 ? void 0 : oldValue.forcedDecimals;
        ...
        if (oldForcedDecimals && newValue && (newValue.pointIndex.prettyIndex < 0)) {
            ...
            oldValue === null || oldValue === void 0 ? void 0 : oldValue.updateValue(`${oldValue === null || oldValue === void 0 ? void 0 : oldValue.numberValue}`.slice(0, -oldForcedDecimals));
        }
        this.value = newValue;
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.11", ngImport: i0, type: IndigitDirective, decorators: [{
    ...
    }, propDecorators: { decimalDigitGroups: [{
                type: Input
            }], integerDigitGroups: [{
                type: Input
            }], decimal: [{
